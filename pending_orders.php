  ...
  <script source="https://cdn.datatables.net/1.10.24/js/jquery.dataTables.min.js" type="text/javascript"></script>
    ...
    <body style="background-color: seagreen;">
        ...
        <div class="w3-container">
            <center> <h2 style=" color: white;font-size: 50px;font-style: var; font-family: monospace" >Pending Orders</h2></center>
                    ...
                    if ($result1->num_rows > 0) {
                        ...
                        while ($row = $result1->fetch_assoc()) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a  href="updatepo.php?dt=<?php echo $row['SubscriptionMaster_ID'] ?>&dt1=<?php echo $pending_order ?>"><input type="button" value="ADD DAYS" style="background-color: green; color: white;"/></a>
