  ...
  <script source="https://cdn.datatables.net/1.10.24/js/jquery.dataTables.min.js" type="text/javascript"></script>
    ...
    <body style="background-color: seagreen;">
        ...
        <div class="w3-container">
            <center> <h2 style=" color: white;font-size: 50px;font-style: var; font-family: monospace" >Customer's Subscription</h2></center>
